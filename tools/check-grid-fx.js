...
// the cubes behind" - and, after seeing an overlay experiment, "the frame must
...
// window closes it.
{
  ...
  stack = [blocker, cube];
  move(70, 10);
  expect(!cube.classList.contains('frame'), 'a surface that covers the wall must hide the frame again - never on top of content');
  stack = [cube];
  move(130, 65);
